<header class="header white-bg">
          <div class="navbar-header">
              ...
              <!--logo start-->
              <a href="slide5.php" class="logo" ><span>Clickrstop</span></a>
              <!--logo end-->
                <div class="container">
                            ...
                            <li class="dropdown yamm-fw"><a href="#" data-toggle="dropdown" class="dropdown-toggle">Images Menu <b class=" fa fa-angle-down"></b></a>
                                <ul class="dropdown-menu">
                                    <li>
                                        <div class="yamm-content">
                                            <div class="row">
                                                <div class="col-xs-6 col-sm-2"><a href="#" class="m-thumb"><img  src="images/mega-menu-images1.jpg"> Anim pariatur</a></div>
                                                <div class="col-xs-6 col-sm-2"><a href="#" class="m-thumb"><img  src="images/mega-menu-images2.jpg"> Reprehenderit</a></div>
                                                <div class="col-xs-6 col-sm-2"><a href="#" class="m-thumb"><img  src="images/mega-menu-images3.jpg"> Keffiyeh helvetica</a></div>
                                                <div class="col-xs-6 col-sm-2"><a href="#" class="m-thumb"><img  src="images/mega-menu-images4.jpg"> Pariatur cliche</a></div>
                                                <div class="col-xs-6 col-sm-2"><a href="#" class="m-thumb"><img  src="images/mega-menu-images5.jpg"> Food truck quinoa</a></div>
                                                <div class="col-xs-6 col-sm-2"><a href="#" class="m-thumb"><img  src="images/mega-menu-images6.jpg"> Leggings occaecat craft</a></div>
                                            </div>
                                        </div>
                                    </li>
                                </ul>
